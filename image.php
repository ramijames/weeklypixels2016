		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<header class="entry-header">
				...
				<nav role="navigation" id="image-navigation" class="image-navigation">
					<div class="nav-previous"><?php previous_image_link( false, __( '<span class="meta-nav"><i class="fa fa-chevron-left"></i></span> Previous', '_tk' ) ); ?></div>
					<div class="nav-next"><?php next_image_link( false, __( 'Next <span class="meta-nav"><i class="fa fa-chevron-right"></i></span>', '_tk' ) ); ?></div>
